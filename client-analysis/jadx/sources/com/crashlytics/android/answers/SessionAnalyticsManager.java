...
class SessionAnalyticsManager implements BackgroundManager.Listener {
    ...
    public static SessionAnalyticsManager build(Kit kit, Context context, IdManager idManager, String versionCode, String versionName, long installedAt) {
        ...
        AnswersEventsHandler eventsHandler = new AnswersEventsHandler(kit, context, filesManagerProvider, metadataCollector, httpRequestFactory, executorService);
        AnswersPreferenceManager preferenceManager = AnswersPreferenceManager.build(context);
        return new SessionAnalyticsManager(eventsHandler, lifecycleManager, backgroundManager, preferenceManager, installedAt);
    }
