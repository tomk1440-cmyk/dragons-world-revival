...
class GameHelperUtils {
    ...
    private static final int[] RES_IDS = new int[0];
    ...
    static String getString(Context ctx, int whichString) {
        ...
        try {
            ...
            ex.printStackTrace();
            Log.w("Prime31-GH", "*** GameHelper could not found resource id #" + resId + ". This probably happened because you included it as a stand-alone JAR. BaseGameUtils should be compiled as a LIBRARY PROJECT, so that it can access its resources. Using a fallback string.");
