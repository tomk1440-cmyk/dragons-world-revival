...
public class AdjustEvent {
    ...
    public void addCallbackParameter(String key, String value) {
        if (Util.isValidParameter(key, "key", "Callback") && Util.isValidParameter(value, "value", "Callback")) {
            ...
            String previousValue = this.callbackParameters.put(key, value);
    ...
    public void addPartnerParameter(String key, String value) {
        if (Util.isValidParameter(key, "key", "Partner") && Util.isValidParameter(value, "value", "Partner")) {
            ...
            String previousValue = this.partnerParameters.put(key, value);
            if (previousValue != null) {
                logger.warn("Key %s was overwritten", key);
            }
        }
    ...
    private static boolean checkEventToken(String eventToken, ILogger logger2) {
        if (eventToken == null) {
        ...
        logger2.error("Malformed Event Token '%s'", eventToken);
        return false;
    }
