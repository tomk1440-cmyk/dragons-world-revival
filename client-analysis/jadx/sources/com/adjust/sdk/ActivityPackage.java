...
public class ActivityPackage implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && getClass() == other.getClass()) {
            ...
            return Util.equalString(this.path, otherActivityPackage.path) && Util.equalString(this.clientSdk, otherActivityPackage.clientSdk) && Util.equalObject(this.parameters, otherActivityPackage.parameters) && Util.equalEnum(this.activityKind, otherActivityPackage.activityKind) && Util.equalString(this.suffix, otherActivityPackage.suffix) && Util.equalObject(this.callbackParameters, otherActivityPackage.callbackParameters) && Util.equalObject(this.partnerParameters, otherActivityPackage.partnerParameters);
        }
        return false;
    }
