...
public final class g extends Dialog implements TextWatcher, View.OnClickListener {
    ...
    public g(Context context, UnityPlayer unityPlayer, String str, int i, boolean z, boolean z2, boolean z3, String str2) {
        super(context);
        this.a = null;
        this.b = null;
        this.a = context;
        ...
        editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.unity3d.player.g.1
    ...
    private static int a(int i, boolean z, boolean z2, boolean z3) {
        int i2 = (z3 ? 128 : 0) | (z2 ? 131072 : 0) | (z ? 32768 : 524288);
        return (i < 0 || i > 10) ? i2 : i2 | new int[]{1, 16385, 12290, 17, 2, 3, 97, 33, 1, 16417, 17}[i];
    }
    ...
    protected final View createSoftInputView() {
        ...
        EditText editText = new EditText(this.a) { // from class: com.unity3d.player.g.2
            ...
            public final void onWindowFocusChanged(boolean z) {
                ...
                if (z) {
                    ((InputMethodManager) g.this.a.getSystemService("input_method")).showSoftInput(this, 0);
                }
            }
        };
        ...
        button.setText(this.a.getResources().getIdentifier("ok", "string", AbstractSpiCall.ANDROID_CLIENT_TYPE));
        ...
        ((EditText) relativeLayout.findViewById(1057292289)).setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: com.unity3d.player.g.3
