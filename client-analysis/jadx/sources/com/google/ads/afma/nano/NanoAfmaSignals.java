...
public interface NanoAfmaSignals {
    ...
    public static final class AFMASignals extends zzsu {
        ...
        public static final class TouchInfo extends zzsu {
            ...
            protected int zzz() {
                int iZzz = super.zzz();
                if (this.tcxSignal != null) {
                    iZzz += zzsn.zzd(1, this.tcxSignal.longValue());
                }
                return this.tcySignal != null ? iZzz + zzsn.zzd(2, this.tcySignal.longValue()) : iZzz;
            }
        }
                ...
                switch (iZzIX) {
                    ...
                    case 208:
                        ...
                        switch (iZzJb) {
                            ...
                            case 5:
                            case 6:
                                this.didSignalType = Integer.valueOf(iZzJb);
                                break;
                        }
                        break;
                    case 218:
                    ...
                    case 336:
                        ...
                        break;
                    case 346:
                        int iZzc = zzsx.zzc(input, 346);
                        int length = this.previousTouches == null ? 0 : this.previousTouches.length;
                        TouchInfo[] touchInfoArr = new TouchInfo[iZzc + length];
                        if (length != 0) {
        ...
        protected int zzz() {
            int iZzz = super.zzz();
            if (this.osVersion != null) {
                iZzz += zzsn.zzo(1, this.osVersion);
            }
            if (this.afmaVersion != null) {
                iZzz += zzsn.zzo(2, this.afmaVersion);
            }
            if (this.atvSignal != null) {
                iZzz += zzsn.zzd(3, this.atvSignal.longValue());
            }
            if (this.attSignal != null) {
                iZzz += zzsn.zzd(4, this.attSignal.longValue());
            }
            if (this.btsSignal != null) {
                iZzz += zzsn.zzd(5, this.btsSignal.longValue());
            }
            if (this.btlSignal != null) {
                iZzz += zzsn.zzd(6, this.btlSignal.longValue());
            }
            if (this.acxSignal != null) {
                iZzz += zzsn.zzd(7, this.acxSignal.longValue());
            }
            if (this.acySignal != null) {
                iZzz += zzsn.zzd(8, this.acySignal.longValue());
            }
            if (this.aczSignal != null) {
                iZzz += zzsn.zzd(9, this.aczSignal.longValue());
            }
            if (this.actSignal != null) {
                iZzz += zzsn.zzd(10, this.actSignal.longValue());
            }
            if (this.netSignal != null) {
                iZzz += zzsn.zzd(11, this.netSignal.longValue());
            }
            if (this.ornSignal != null) {
                iZzz += zzsn.zzd(12, this.ornSignal.longValue());
            }
            if (this.stkSignal != null) {
                iZzz += zzsn.zzo(13, this.stkSignal);
            }
            if (this.tcxSignal != null) {
                iZzz += zzsn.zzd(14, this.tcxSignal.longValue());
            }
            if (this.tcySignal != null) {
                iZzz += zzsn.zzd(15, this.tcySignal.longValue());
            }
            if (this.tctSignal != null) {
                iZzz += zzsn.zzd(16, this.tctSignal.longValue());
            }
            if (this.uptSignal != null) {
                iZzz += zzsn.zzd(17, this.uptSignal.longValue());
            }
            if (this.visSignal != null) {
                iZzz += zzsn.zzd(18, this.visSignal.longValue());
            }
            if (this.swzSignal != null) {
                iZzz += zzsn.zzd(19, this.swzSignal.longValue());
            }
            if (this.psnSignal != null) {
                iZzz += zzsn.zzd(20, this.psnSignal.longValue());
            }
            if (this.reqType != null) {
                iZzz += zzsn.zzd(21, this.reqType.longValue());
            }
            if (this.jbkSignal != null) {
                iZzz += zzsn.zzd(22, this.jbkSignal.longValue());
            }
            if (this.usgSignal != null) {
                iZzz += zzsn.zzd(23, this.usgSignal.longValue());
            }
            if (this.didSignal != null) {
                iZzz += zzsn.zzo(24, this.didSignal);
            }
            if (this.evtTime != null) {
                iZzz += zzsn.zzd(25, this.evtTime.longValue());
            }
            if (this.didSignalType != null) {
                iZzz += zzsn.zzC(26, this.didSignalType.intValue());
            }
            if (this.intSignal != null) {
                iZzz += zzsn.zzo(27, this.intSignal);
            }
            if (this.didOptOut != null) {
                iZzz += zzsn.zzf(28, this.didOptOut.booleanValue());
            }
            if (this.cerSignal != null) {
                iZzz += zzsn.zzo(29, this.cerSignal);
            }
            if (this.didSignalAndroidAdId != null) {
                iZzz += zzsn.zzo(30, this.didSignalAndroidAdId);
            }
            if (this.uwSignal != null) {
                iZzz += zzsn.zzd(31, this.uwSignal.longValue());
            }
            if (this.uhSignal != null) {
                iZzz += zzsn.zzd(32, this.uhSignal.longValue());
            }
            if (this.utzSignal != null) {
                iZzz += zzsn.zzd(33, this.utzSignal.longValue());
            }
            if (this.vnmSignal != null) {
                iZzz += zzsn.zzo(34, this.vnmSignal);
            }
            if (this.vcdSignal != null) {
                iZzz += zzsn.zzd(35, this.vcdSignal.longValue());
            }
            if (this.tcpSignal != null) {
                iZzz += zzsn.zzd(36, this.tcpSignal.longValue());
            }
            if (this.tcdSignal != null) {
                iZzz += zzsn.zzd(37, this.tcdSignal.longValue());
            }
            if (this.adAttestationSignal != null) {
                iZzz += zzsn.zzc(38, this.adAttestationSignal);
            }
            if (this.tcuSignal != null) {
                iZzz += zzsn.zzd(39, this.tcuSignal.longValue());
            }
            if (this.tcmSignal != null) {
                iZzz += zzsn.zzd(40, this.tcmSignal.longValue());
            }
            if (this.tcdnSignal != null) {
                iZzz += zzsn.zzd(41, this.tcdnSignal.longValue());
            }
            if (this.tccSignal != null) {
                iZzz += zzsn.zzd(42, this.tccSignal.longValue());
            }
            if (this.previousTouches != null && this.previousTouches.length > 0) {
                int iZzc = iZzz;
                for (int i = 0; i < this.previousTouches.length; i++) {
                    TouchInfo touchInfo = this.previousTouches[i];
                    if (touchInfo != null) {
                        iZzc += zzsn.zzc(43, touchInfo);
                    }
                }
                iZzz = iZzc;
            }
            return this.rawAdAttestationSignal != null ? iZzz + zzsn.zzc(201, this.rawAdAttestationSignal) : iZzz;
        }
    }
    ...
    public static final class AdAttestationSignal extends zzsu {
                ...
                switch (iZzIX) {
                    ...
                    case 16:
                        ...
                        switch (iZzJb) {
                            ...
                            case 2:
                            case 3:
                                this.responseType = Integer.valueOf(iZzJb);
                                break;
                        }
                        break;
                    case 24:
        ...
        protected int zzz() {
            int iZzz = super.zzz();
            if (this.timestampMs != null) {
                iZzz += zzsn.zzd(1, this.timestampMs.longValue());
            }
            if (this.responseType != null) {
                iZzz += zzsn.zzC(2, this.responseType.intValue());
            }
            if (this.suspicious != null) {
                iZzz += zzsn.zzf(3, this.suspicious.booleanValue());
            }
            return this.reasons != null ? iZzz + zzsn.zzC(4, this.reasons.intValue()) : iZzz;
        }
    }
    ...
    public static final class AdSignalsContainer extends zzsu {
        ...
        protected int zzz() {
            int iZzz = super.zzz();
            if (this.encryptedSpamSignals != null) {
                iZzz += zzsn.zzb(1, this.encryptedSpamSignals);
            }
            return this.encryptedDidSignal != null ? iZzz + zzsn.zzb(2, this.encryptedDidSignal) : iZzz;
        }
    }
    ...
    public static final class RawAdAttestationSignal extends zzsu {
        ...
        protected int zzz() {
            ...
            if (this.keyIdentifier != null) {
                iZzz += zzsn.zzo(3, this.keyIdentifier);
            }
            return this.encryptedAdAttestationStatemement != null ? iZzz + zzsn.zzb(4, this.encryptedAdAttestationStatemement) : iZzz;
        }
    }
}
