...
public interface zzoj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzoj {
        ...
        private static class C0147zza implements zzoj {
        ...
        public static zzoj zzbE(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzoj)) ? new C0147zza(iBinder) : (zzoj) iInterfaceQueryLocalInterface;
        }
