...
public interface zzpo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpo {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzpo$zza$zza, reason: collision with other inner class name */
        private static class C0165zza implements zzpo {
        ...
        public static zzpo zzcb(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzpo)) ? new C0165zza(iBinder) : (zzpo) iInterfaceQueryLocalInterface;
        }
