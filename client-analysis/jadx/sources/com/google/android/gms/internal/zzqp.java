...
public interface zzqp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqp {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzqp$zza$zza, reason: collision with other inner class name */
        private static class C0175zza implements zzqp {
            ...
            public void zza(zzqo zzqoVar, Uri uri, Bundle bundle, boolean z) throws RemoteException {
        ...
        public static zzqp zzdL(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzqp)) ? new C0175zza(iBinder) : (zzqp) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(zzqo.zza.zzdK(data.readStrongBinder()), data.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt() != 0);
                    return true;
                case 1598968902:
    ...
    void zza(zzqo zzqoVar, Uri uri, Bundle bundle, boolean z) throws RemoteException;
}
