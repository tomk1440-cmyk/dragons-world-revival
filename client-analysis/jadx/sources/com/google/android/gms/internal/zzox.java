...
public interface zzox extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzox {
        ...
        private static class C0161zza implements zzox {
        ...
        public static zzox zzbS(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzox)) ? new C0161zza(iBinder) : (zzox) iInterfaceQueryLocalInterface;
        }
