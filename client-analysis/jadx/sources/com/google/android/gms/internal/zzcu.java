...
public interface zzcu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcu {
        ...
        private static class C0100zza implements zzcu {
            ...
            public void zza(zzcp zzcpVar) throws RemoteException {
        ...
        public static zzcu zzC(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcu)) ? new C0100zza(iBinder) : (zzcu) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(zzcp.zza.zzy(data.readStrongBinder()));
    ...
    void zza(zzcp zzcpVar) throws RemoteException;
}
