...
public interface zzot extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzot {
        ...
        private static class C0157zza implements zzot {
        ...
        public static zzot zzbO(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzot)) ? new C0157zza(iBinder) : (zzot) iInterfaceQueryLocalInterface;
        }
