...
public interface zzry extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzry {

        /* JADX INFO: renamed from: com.google.android.gms.internal.zzry$zza$zza, reason: collision with other inner class name */
        private static class C0181zza implements zzry {
        ...
        public static zzry zzek(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzry)) ? new C0181zza(iBinder) : (zzry) iInterfaceQueryLocalInterface;
        }
