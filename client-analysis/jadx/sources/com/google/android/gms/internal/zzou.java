...
public interface zzou extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzou {
        ...
        private static class C0158zza implements zzou {
        ...
        public static zzou zzbP(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzou)) ? new C0158zza(iBinder) : (zzou) iInterfaceQueryLocalInterface;
        }
