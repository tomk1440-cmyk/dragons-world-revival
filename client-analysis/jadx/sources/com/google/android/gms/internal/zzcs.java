...
public interface zzcs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcs {
        ...
        private static class C0098zza implements zzcs {
            ...
            public void zza(zzcn zzcnVar) throws RemoteException {
        ...
        public static zzcs zzA(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcs)) ? new C0098zza(iBinder) : (zzcs) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(zzcn.zza.zzx(data.readStrongBinder()));
    ...
    void zza(zzcn zzcnVar) throws RemoteException;
}
