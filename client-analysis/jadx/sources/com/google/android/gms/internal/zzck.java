...
public interface zzck extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzck {
        ...
        private static class C0093zza implements zzck {
        ...
        public static zzck zzv(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzck)) ? new C0093zza(iBinder) : (zzck) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder iBinderZza = zza(com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()), com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()), com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()), data.readInt());
