...
public interface zzqo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqo {

        /* JADX INFO: renamed from: com.google.android.gms.internal.zzqo$zza$zza, reason: collision with other inner class name */
        private static class C0174zza implements zzqo {
        ...
        public static zzqo zzdK(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzqo)) ? new C0174zza(iBinder) : (zzqo) iInterfaceQueryLocalInterface;
        }
