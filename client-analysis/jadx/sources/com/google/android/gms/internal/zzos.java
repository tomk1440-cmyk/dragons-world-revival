...
public interface zzos extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzos {
        ...
        private static class C0156zza implements zzos {
        ...
        public static zzos zzbN(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzos)) ? new C0156zza(iBinder) : (zzos) iInterfaceQueryLocalInterface;
        }
