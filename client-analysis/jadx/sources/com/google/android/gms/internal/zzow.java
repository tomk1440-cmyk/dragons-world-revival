...
public interface zzow extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzow {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzow$zza$zza, reason: collision with other inner class name */
        private static class C0160zza implements zzow {
        ...
        public static zzow zzbR(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzow)) ? new C0160zza(iBinder) : (zzow) iInterfaceQueryLocalInterface;
        }
