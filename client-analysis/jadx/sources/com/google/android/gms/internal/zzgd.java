...
public interface zzgd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgd {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzgd$zza$zza, reason: collision with other inner class name */
        private static class C0118zza implements zzgd {
        ...
        public static zzgd zzP(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzgd)) ? new C0118zza(iBinder) : (zzgd) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(zzgc.zza.zzO(data.readStrongBinder()));
