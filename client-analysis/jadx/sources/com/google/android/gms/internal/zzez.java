...
public interface zzez extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzez {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzez$zza$zza, reason: collision with other inner class name */
        private static class C0110zza implements zzez {
        ...
        public static zzez zzG(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzez)) ? new C0110zza(iBinder) : (zzez) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 7:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
                    zza(zzfa.zza.zzH(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zza(zzfa zzfaVar) throws RemoteException;
}
