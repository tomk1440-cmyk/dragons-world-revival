...
public interface zzge extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzge {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzge$zza$zza, reason: collision with other inner class name */
        private static class C0119zza implements zzge {
        ...
        public static zzge zzQ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzge)) ? new C0119zza(iBinder) : (zzge) iInterfaceQueryLocalInterface;
        }
