...
public interface zzt extends IInterface {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder iBinderZza = zza(com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()), data.readString(), zzex.zza.zzE(data.readStrongBinder()), data.readInt());
    ...
    IBinder zza(com.google.android.gms.dynamic.zzd zzdVar, String str, zzex zzexVar, int i) throws RemoteException;
}
