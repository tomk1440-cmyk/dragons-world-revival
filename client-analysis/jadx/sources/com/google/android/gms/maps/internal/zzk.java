...
public interface zzk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzk {
        ...
        private static class C0224zza implements zzk {
        ...
        public static zzk zzcG(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzk)) ? new C0224zza(iBinder) : (zzk) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zzu(com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()));
