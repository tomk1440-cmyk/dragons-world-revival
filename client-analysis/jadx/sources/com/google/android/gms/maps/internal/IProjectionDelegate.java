...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IProjectionDelegate {
        ...
        private static class C0208zza implements IProjectionDelegate {
        ...
        public static IProjectionDelegate zzcX(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IProjectionDelegate)) ? new C0208zza(iBinder) : (IProjectionDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    LatLng latLngFromScreenLocation = fromScreenLocation(com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()));
