...
public interface IStreetViewPanoramaFragmentDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IStreetViewPanoramaFragmentDelegate {
        ...
        private static class C0210zza implements IStreetViewPanoramaFragmentDelegate {
        ...
        public static IStreetViewPanoramaFragmentDelegate zzda(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IStreetViewPanoramaFragmentDelegate)) ? new C0210zza(iBinder) : (IStreetViewPanoramaFragmentDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    onInflate(com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()), data.readInt() != 0 ? StreetViewPanoramaOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                ...
                case 12:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    getStreetViewPanoramaAsync(zzaa.zza.zzcW(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void getStreetViewPanoramaAsync(zzaa zzaaVar) throws RemoteException;
