...
public final class BitmapDescriptorFactory {
    ...
    public static BitmapDescriptor defaultMarker(float hue) {
        try {
            return new BitmapDescriptor(zzAi().zzh(hue));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static BitmapDescriptor fromAsset(String assetName) {
        try {
            return new BitmapDescriptor(zzAi().zzer(assetName));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static BitmapDescriptor fromBitmap(Bitmap image) {
        try {
            return new BitmapDescriptor(zzAi().zzc(image));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static BitmapDescriptor fromFile(String fileName) {
        try {
            return new BitmapDescriptor(zzAi().zzes(fileName));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static BitmapDescriptor fromPath(String absolutePath) {
        try {
            return new BitmapDescriptor(zzAi().zzet(absolutePath));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static BitmapDescriptor fromResource(int resourceId) {
        try {
            return new BitmapDescriptor(zzAi().zziz(resourceId));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
