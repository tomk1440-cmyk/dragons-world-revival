...
public class HitBuilders {
    ...
    public static class HitBuilder<T extends HitBuilder> {
        ...
        public Map<String, String> build() {
            ...
            Iterator<Promotion> it = this.zzPp.iterator();
            int i = 1;
            while (it.hasNext()) {
                map.putAll(it.next().zzba(zzc.zzZ(i)));
                i++;
            }
            Iterator<Product> it2 = this.zzPq.iterator();
            int i2 = 1;
            while (it2.hasNext()) {
                map.putAll(it2.next().zzba(zzc.zzX(i2)));
                i2++;
            }
            int i3 = 1;
            for (Map.Entry<String, List<Product>> entry : this.zzPo.entrySet()) {
                ...
                int i4 = 1;
                while (it3.hasNext()) {
                    map.putAll(it3.next().zzba(strZzac + zzc.zzab(i4)));
                    i4++;
                }
        ...
        public T setCampaignParamsFromUrl(String utmParams) {
            String strZzbu = zzam.zzbu(utmParams);
            if (!TextUtils.isEmpty(strZzbu)) {
                Map<String, String> mapZzbs = zzam.zzbs(strZzbu);
                set("&cc", mapZzbs.get("utm_content"));
                set("&cm", mapZzbs.get("utm_medium"));
                set("&cn", mapZzbs.get("utm_campaign"));
                set("&cs", mapZzbs.get("utm_source"));
                set("&ck", mapZzbs.get("utm_term"));
                set("&ci", mapZzbs.get("utm_id"));
                set("&anid", mapZzbs.get("anid"));
                set("&gclid", mapZzbs.get("gclid"));
                set("&dclid", mapZzbs.get("dclid"));
                set("&aclid", mapZzbs.get("aclid"));
                set("&gmob_t", mapZzbs.get("gmob_t"));
            }
            return this;
        }
