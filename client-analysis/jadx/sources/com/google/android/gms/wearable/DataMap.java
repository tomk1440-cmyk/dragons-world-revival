...
public class DataMap {
    ...
    public static DataMap fromByteArray(byte[] bytes) {
        try {
            return zzsi.zza(new zzsi.zza(zzsj.zzA(bytes), new ArrayList()));
        } catch (zzst e) {
    ...
    private static boolean zza(Asset asset, Asset asset2) {
        ...
        return !TextUtils.isEmpty(asset.getDigest()) ? asset.getDigest().equals(asset2.getDigest()) : Arrays.equals(asset.getData(), asset2.getData());
    }
    ...
    public boolean containsKey(String key) {
        return this.zzbrc.containsKey(key);
    }
    ...
    public <T> T get(String str) {
        return (T) this.zzbrc.get(str);
    }

    public Asset getAsset(String key) {
        Object obj = this.zzbrc.get(key);
        if (obj == null) {
            return null;
        }
        try {
    ...
    public void putAsset(String key, Asset value) {
        this.zzbrc.put(key, value);
    }

    public void putBoolean(String key, boolean value) {
        this.zzbrc.put(key, Boolean.valueOf(value));
    }

    public void putByte(String key, byte value) {
        this.zzbrc.put(key, Byte.valueOf(value));
    }
    ...
    public void putDouble(String key, double value) {
        this.zzbrc.put(key, Double.valueOf(value));
    }

    public void putFloat(String key, float value) {
        this.zzbrc.put(key, Float.valueOf(value));
    }
    ...
    public void putInt(String key, int value) {
        this.zzbrc.put(key, Integer.valueOf(value));
    }
    ...
    public void putLong(String key, long value) {
        this.zzbrc.put(key, Long.valueOf(value));
    }
