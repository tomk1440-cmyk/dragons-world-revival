...
public class GoogleSignInAccount implements SafeParcelable {
    ...
    private static Comparator<Scope> zzWV = new Comparator<Scope>() { // from class: com.google.android.gms.auth.api.signin.GoogleSignInAccount.1
    ...
    public static GoogleSignInAccount zzbH(@Nullable String str) throws JSONException {
        ...
        return zza(jSONObject.optString(ShareConstants.WEB_DIALOG_PARAM_ID), jSONObject.optString("tokenId", null), jSONObject.optString("email", null), jSONObject.optString("displayName", null), uri, Long.valueOf(j), jSONObject.getString("obfuscatedIdentifier"), hashSet).zzbI(jSONObject.optString("serverAuthCode", null));
    }
    ...
    private JSONObject zzmJ() {
        ...
        try {
            ...
            Iterator<Scope> it = this.zzVs.iterator();
            while (it.hasNext()) {
