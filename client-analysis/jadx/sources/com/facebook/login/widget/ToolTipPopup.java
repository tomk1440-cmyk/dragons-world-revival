...
public class ToolTipPopup {
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            registerObserver();
            this.mPopupContent.measure(View.MeasureSpec.makeMeasureSpec(decorWidth, ExploreByTouchHelper.INVALID_ID), View.MeasureSpec.makeMeasureSpec(decorHeight, ExploreByTouchHelper.INVALID_ID));
