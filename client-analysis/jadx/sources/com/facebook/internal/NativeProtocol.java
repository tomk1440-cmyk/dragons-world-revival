...
public final class NativeProtocol {
    ...
    private static abstract class NativeAppInfo {
        ...
        /* JADX WARN: Code duplicated, block: B:6:0x0007 A[Catch: all -> 0x000f, TRY_LEAVE, TryCatch #0 {, blocks: (B:4:0x0003, B:6:0x0007), top: B:12:0x0003 }] */
        public synchronized void fetchAvailableVersions(boolean force) {
            ...
            } else if (this.availableVersions == null) {
                this.availableVersions = NativeProtocol.fetchAllAvailableProtocolVersionsForAppInfo(this);
            }
        }
    }
